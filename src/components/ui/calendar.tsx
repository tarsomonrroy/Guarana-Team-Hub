...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      components={{
        Nav: ({ children, ...navProps }) => (
          <nav {...navProps} className="flex items-center space-x-1">
            <button
              className={cn(
                buttonVariants({ variant: "outline" }),
              ...
              onClick={() => {
                const previousButton = document.querySelector('[aria-label="Go to previous month"]') as HTMLButtonElement;
            ...
            <button
              ...
              onClick={() => {
                const nextButton = document.querySelector('[aria-label="Go to next month"]') as HTMLButtonElement;
                nextButton?.click();
              }}
            >
